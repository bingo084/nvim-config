		...
		cli = {
			...
			win = {
				keys = {
					...
					nav_left = { "<A-h>", "nav_left", expr = false, desc = "navigate to the left window" },
					nav_down = { "<A-j>", "nav_down", expr = false, desc = "navigate to the below window" },
					nav_up = { "<A-k>", "nav_up", expr = false, desc = "navigate to the above window" },
					nav_right = { "<A-l>", "nav_right", expr = false, desc = "navigate to the right window" },
				},
			},
